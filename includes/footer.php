                ...
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                        ...
                        <div class="textwidget pr-60 md-pr-15">
                            <p>We are a next generation IT training institute. We provide all kinds of industrial training in computer science technologies.</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 pl-50 md-pl-15 footer-widget md-mb-50">
                        ...
                        <ul class="site-map">
                            <li><a href="#">C and C++ programming</a></li>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 pl-50 md-pl-15 footer-widget md-mb-50">
                        ...
                        <ul class="site-map">
                            ...
                            <li><a href="#">Graphics Desinging</a></li>
                            <li><a href="#">ReactJS + Redux</a></li>
                            <li><a href="#">NodeJS + ExpressJS</a></li>
                            <li><a href="#">Spring & Hibernate</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row y-middle">
                    <div class="col-lg-6 md-mb-20">
                        <div class="copyright">
                            <p>&copy; 2023 All Rights Reserved. Developed By <a href="http://grootsoftware.com/">Groot Software</a>
                            </p>
                        </div>
                    </div>
...
<!-- Mirrored from keenitsolutions.com/products/html/educavo/index12.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 08:00:29 GMT -->
