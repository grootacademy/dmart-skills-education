                            ...
                            <div class="tab-pane tab fade show active" id="prod-overview" role="tabpanel" aria-labelledby="prod-overview-tab">
                                <div class="content white-bg pt-30">
                                    ...
                                    <div class="course-overview">
                                        <div class="inner-box">
                                            <h4>Web Designing Course: Crafting Digital Experiences</h4>
                                            <p>Welcome to our Web Designing Course, where creativity meets technology to shape the digital world. Whether you're an aspiring designer or a professional looking to enhance your skills, our comprehensive course is designed to equip you with the knowledge and tools to create stunning, user-friendly websites and digital experiences.</p>
                                            <h4>Course Overview:</h4>
                                            <p>Our Web Designing Course is your gateway to the exciting realm of web design. In today's digital age, a well-designed website is essential for businesses and individuals alike. This course covers everything from the fundamentals of design principles to the latest trends and technologies in web design.</p>
                                            ...
                                            <ul class="review-list">
                                                <li><b>Introduction to Web Design:</b>Explore the basics of web design, including layout, color theory, typography, and user experience (UX) principles.</li>
                                                <li><b>HTML and CSS:</b> Dive into the foundations of web development with HTML and CSS, allowing you to create and style web pages.</li>
                                                <li><b>Responsive Web Design:</b> Learn to design websites that adapt seamlessly to various devices and screen sizes, ensuring a consistent user experience.
                                                </li>
                                                <li><b>User Interface (UI) Design:</b> Master the art of creating visually appealing and user-friendly interfaces that captivate users.</li>
                                                <li><b>Design Tools: </b> Familiarize yourself with industry-standard design tools like Adobe XD, Figma, and Sketch.</li>
                                                <li><b>Wireframing and Prototyping:</b>Develop wireframes and prototypes to plan and visualize your website's layout and functionality.</li>
                                                <li><b>Web Animation:</b> Explore the world of web animation to add interactivity and engagement to your designs.
                                                <li><b>Portfolio Development:</b>Build a professional portfolio showcasing your web design projects to impress potential clients or employers.
                                                </li>
                                                </li>
                                            </ul>
                                            <h3>Why Choose Our Web Designing Course:</h3>
                                            <ul class="review-list">
                                                <li><b>Expert Guidance:</b> Learn from experienced web designers who share industry insights and best practices.</li>
                                                <li><b>Hands-On Projects: </b> Apply your knowledge through practical projects that reflect real-world design scenarios.</li>
                                                <li><b>Career Prospects:</b>Web designers are in high demand across industries, making this course a valuable asset to your career.</li>
                                                <li><b>Personalized Learning:</b>Our course is designed to cater to various skill levels, from beginners to experienced designers.</li>
                                                </li>
                                            </ul>
                                            <h3>Who Should Enroll:</h3>
                                            <ul class="review-list">
                                                <li>Aspiring web designers and graphic designers.</li>
                                                <li>Students pursuing design or related fields.</li>
                                                <li>Professionals seeking to enhance their web design skills.</li>
                                                <li>Entrepreneurs and business owners looking to create their websites.</li>
                                            </ul>
                                            <h3>Your Web Designing Journey Begins Here:</h3>
                                            <p>With our Web Designing Course, you're not just learning design; you're acquiring the ability to craft digital experiences that leave a lasting impact. Join us in exploring the exciting world of web design, where creativity knows no bounds.</p>                             
                                            <h3>Get in Touch:</h3>
                                            <p>Ready to embark on your web design adventure? Contact us today to enroll in our Web Designing Course and start your path to becoming a proficient web designer.

(Note: The provided content is designed to introduce the Web Designing Course. It's recommended to adapt the content to your specific course offerings and website format.)</p>                                            <!--                                           
                                            <h3>Requirements</h3>
                                            <ul class="review-list">
