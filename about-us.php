...
<div class="main-content">
			...
			<div class="row">
				<div class="col-lg-4 col-sm-6 mb-30">
					<div class="team-item">
						...
						<div class="content-part">
							<h4 class="name"><a href="/team-member-satnam-singh-sir">Satnam Singh</a></h4>
	...
	<!-- Team Section End -->
	<!-- Students Testimonial Section Start -->
			...
			<div class="rs-carousel owl-carousel" data-loop="true" data-items="2" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="true" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="2" data-md-device-nav="false" data-md-device-dots="true">
					...
					<div class="row y-middle no-gutter">
						<div class="col-md-4">
							<div class="user-info">
								...
								<h4 class="name">Sunil Kumawat</h4>
						...
						<div class="col-md-8">
							<div class="desc">Teaching is so good. Best institute for coaching. I have taken selenium with a java course, i didn't expect i will learn up to this level. I recommend joining the institute if you are trying to take any course in testing.</div>
						</div>
					</div>
				</div>
				<div class="testi-item">
					<div class="row y-middle no-gutter">
						<div class="col-md-4">
							<div class="user-info">
								...
								<h4 class="name">Simmi Manghwani</h4>
								<span class="designation">Student</span>
								<ul class="ratings">
									<li><i class="fa fa-star"></i></li>
									<li><i class="fa fa-star"></i></li>
					...
					<div class="row y-middle no-gutter">
						<div class="col-md-4">
							<div class="user-info">
								...
								<h4 class="name">Shubham saini</h4>
								<span class="designation">Student</span>
								<ul class="ratings">
									<li><i class="fa fa-star"></i></li>
									<li><i class="fa fa-star"></i></li>
						...
						<div class="col-md-8">
							<div class="desc">Right now I am taking coaching on Java Full stack web development here.Excellent coaching. Satnam sir has great teaching technique.</div>
						</div>
					</div>
				</div>
				<div class="testi-item">
					<div class="row y-middle no-gutter">
						<div class="col-md-4">
							<div class="user-info">
								...
								<h4 class="name">SACHIN KUMAWAT</h4>
								<span class="designation">Student</span>
								<ul class="ratings">
									<li><i class="fa fa-star"></i></li>
									<li><i class="fa fa-star"></i></li>
						...
						<div class="col-md-8">
							<div class="desc">Learning at Dmart Skills education has helped me develop my web development skills. The past year has been remarkable in my professional journey. A big thanks to all my team members for providing such a wonderful learning atmosphere.</div>
						</div>
					</div>
				</div>
				<div class="testi-item">
					<div class="row y-middle no-gutter">
						<div class="col-md-4">
							<div class="user-info">
								<img src="assets/images/students/Jhanvi_Vashisth.png" alt="">
								<h4 class="name">Jhanvi Vashisth</h4>
								<span class="designation">Student</span>
								<ul class="ratings">
									<li><i class="fa fa-star"></i></li>
									<li><i class="fa fa-star"></i></li>
						...
						<div class="col-md-8">
							<div class="desc">Course fees are very affordable at Dmart skills education, and students also enjoy the benefits of placement assistance, study materials, and live projects to work upon. It will recommend this the best full stack web development training institute in jaipur. They are having various IT courses like: Master in Frontend development with ReactJs, AngularJS, VueJS, UI/UX Designing, Web Designing, Backend development with Java and NodeJS, Python, Data Science, Data Analytics.</div>
						</div>
					</div>
				</div>
				<div class="testi-item">
					<div class="row y-middle no-gutter">
						<div class="col-md-4">
							<div class="user-info">
								<img src="assets/images/students/Dheeraj_Saini.png" alt="">
								<h4 class="name">Dheeraj Saini</h4>
								<span class="designation">Student</span>
								<ul class="ratings">
									<li><i class="fa fa-star"></i></li>
									<li><i class="fa fa-star"></i></li>
				...
				<div class="testi-item">
					<div class="row y-middle no-gutter">
						<div class="col-md-4">
							<div class="user-info">
								<img src="assets/images/students/Lokesh_Saini.png" alt="">
								<h4 class="name">Lokesh Saini</h4>
								<span class="designation">Student</span>
								<ul class="ratings">
									<li><i class="fa fa-star"></i></li>
									<li><i class="fa fa-star"></i></li>
						...
						<div class="col-md-8">
							<div class="desc">My Guru sir Satnam Sir thank you so much for giving me confidence in the software field. DMart Skills team you always talk about your students. Your behavior is very nice.</div>
						</div>
					</div>
				</div>
				<div class="testi-item">
					<div class="row y-middle no-gutter">
						<div class="col-md-4">
							<div class="user-info">
								<img src="assets/images/students/Kushal-Singh-Shekhawat.png" alt="">
								<h4 class="name">Kushal Singh Shekhawat</h4>
								<span class="designation">Student</span>
								<ul class="ratings">
									<li><i class="fa fa-star"></i></li>
									<li><i class="fa fa-star"></i></li>
				...
				<div class="testi-item">
					<div class="row y-middle no-gutter">
						<div class="col-md-4">
							<div class="user-info">
								<img src="assets/images/students/Sachin-Dahiya.png" alt="">
								<h4 class="name">Sachin Dahiya</h4>
								<span class="designation">Student</span>
								<ul class="ratings">
									<li><i class="fa fa-star"></i></li>
									<li><i class="fa fa-star"></i></li>
						...
						<div class="col-md-8">
							<div class="desc">It was good training trainer is very good knowledge and share it good explaining skills as well and explaining in easy way everyone understand easily trainer very friendly while explain concept i am career gap student but I can easily understand web development i am learning tools and build the my confidence levels thank you DMart Skill Team.</div>
						</div>
					</div>
				</div>
				<div class="testi-item">
					<div class="row y-middle no-gutter">
						...
						<div class="col-md-8">
							<div class="desc">The top institute in Jaipur for people searching for web development courses is DMart Skillsin-person, high-quality teaching in web development classes awesome experience.</div>
						</div>
					</div>
				</div>
			</div>
	...
	<!--Students Testimonial Section End -->
